...
const loadEvent = async _ => {
  ...
  try {
    const MAIN = addAndStore(ROOT, `
      <main class="swiper">
        <div class="swiper-wrapper">
          ...
          ${ data.moreStats ? render({title: "More Statistics", score: data.moreStats}, "swiper-slide more-stats") : "" }
    ...
    .student-${i}{
      --primary: rgb(${e.colours.primary.red},${e.colours.primary.green},${e.colours.primary.blue});
      --secondary: rgb(${e.colours.secondary.red},${e.colours.secondary.green},${e.colours.secondary.blue})
    }
    .student-${i}::before{
